...
　
　それで実際のところ、何がどう複合論理演算なのかというと、先ほども述べた通り、1 / ∞ ≠ 0 という無限虚数学の定式は、存在を極限において取り扱うという点で相対論的極限論理であり、かつ、１＝１に基づくマクロスケールの古典論理と、１→０への動性を探るミクロスケールの量子論理を統合的に表現することができるため、三論理の統合としての複合論理演算であるということになります。この三論理は循環しており、それは、0と1を相対化する原点iの存在によって循環的に定義されます。
